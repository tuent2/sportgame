...
public class Football_Wall : MonoBehaviour
{
    public static Football_Wall instance;
    ...
    private void Start()
    {
		//setWall(Football_Shot.intance._ball.transform.position);
	}
	...
	public void setWall(Vector3 ballPosition)
	{
		...
		{       // count la so nguoi se~ dung' trong hang` rao`, add dzo _bodies
